...
namespace DataCore.Adapter.Grpc.Proxy.RealTimeData.Features {
    internal class ReadProcessedTagValuesImpl : ProxyAdapterFeature, IReadProcessedTagValues {
        ...
        public async Task<IEnumerable<Adapter.RealTimeData.Models.DataFunctionDescriptor>> GetSupportedDataFunctions(IAdapterCallContext context, CancellationToken cancellationToken) {
        ...
        public ChannelReader<Adapter.RealTimeData.Models.ProcessedTagValueQueryResult> ReadProcessedTagValues(IAdapterCallContext context, Adapter.RealTimeData.Models.ReadProcessedTagValuesRequest request, CancellationToken cancellationToken) {
            var result = ChannelExtensions.CreateTagValueChannel<Adapter.RealTimeData.Models.ProcessedTagValueQueryResult>();
