...
#pragma warning disable CA1724 // Type names should not match namespaces
    ...
    public static class WellKnownFeatures {
        ...
        private static readonly IReadOnlyDictionary<string, Type> s_standardFeatureTypeLookup = new ReadOnlyDictionary<string, Type>(new Dictionary<string, Type>() { 
            [string.Intern(AssetModel.AssetModelBrowse)] = typeof(IAssetModelBrowse),
            [string.Intern(AssetModel.AssetModelSearch)] = typeof(IAssetModelSearch),
            [string.Intern(Diagnostics.ConfigurationChanges)] = typeof(IConfigurationChanges),
            [string.Intern(Diagnostics.HealthCheck)] = typeof(IHealthCheck),
            [string.Intern(Events.EventMessagePush)] = typeof(IEventMessagePush),
            [string.Intern(Events.EventMessagePushWithTopics)] = typeof(IEventMessagePushWithTopics),
            [string.Intern(Events.ReadEventMessagesForTimeRange)] = typeof(IReadEventMessagesForTimeRange),
            [string.Intern(Events.ReadEventMessagesUsingCursor)] = typeof(IReadEventMessagesUsingCursor),
            [string.Intern(Events.WriteEventMessages)] = typeof(IWriteEventMessages),
            [string.Intern(Extensions.CustomFunctions)] = typeof(ICustomFunctions),
            [string.Intern(RealTimeData.ReadAnnotations)] = typeof(IReadTagValueAnnotations),
            [string.Intern(RealTimeData.ReadPlotTagValues)] = typeof(IReadPlotTagValues),
            [string.Intern(RealTimeData.ReadProcessedTagValues)] = typeof(IReadProcessedTagValues),
            [string.Intern(RealTimeData.ReadRawTagValues)] = typeof(IReadRawTagValues),
            [string.Intern(RealTimeData.ReadSnapshotTagValues)] = typeof(IReadSnapshotTagValues),
            [string.Intern(RealTimeData.ReadTagValuesAtTimes)] = typeof(IReadTagValuesAtTimes),
            [string.Intern(RealTimeData.SnapshotTagValuePush)] = typeof(ISnapshotTagValuePush),
            [string.Intern(RealTimeData.WriteAnnotations)] = typeof(IWriteTagValueAnnotations),
            [string.Intern(RealTimeData.WriteHistoricalTagValues)] = typeof(IWriteHistoricalTagValues),
            [string.Intern(RealTimeData.WriteSnapshotTagValues)] = typeof(IWriteSnapshotTagValues),
            [string.Intern(Tags.TagInfo)] = typeof(ITagInfo),
            [string.Intern(Tags.TagSearch)] = typeof(ITagSearch),
            [string.Intern(Tags.TagConfiguration)] = typeof(ITagConfiguration)
        });
