...
namespace DataCore.Adapter {
    ...
    public abstract class AdapterBase : AdapterBase<AdapterOptions> {
        ...
        /// </exception>
        protected AdapterBase(string id, string? name, string? description, IBackgroundTaskService? backgroundTaskService, ILoggerFactory? loggerFactory)
            : this(id, Microsoft.Extensions.Options.Options.Create(new AdapterOptions() { Name = name, Description = description }), backgroundTaskService, loggerFactory) { }
        ...
        /// </exception>
        protected AdapterBase(string id, AdapterOptions options, IBackgroundTaskService? backgroundTaskService, ILoggerFactory? loggerFactory)
        ...
        /// </exception>
        protected AdapterBase(string id, IOptions<AdapterOptions> options, IBackgroundTaskService? backgroundTaskService, ILoggerFactory? loggerFactory)
        ...
        /// </remarks>
        protected AdapterBase(string id, IOptionsMonitor<AdapterOptions> optionsMonitor, IBackgroundTaskService? backgroundTaskService, ILoggerFactory? loggerFactory)
            : base(id, optionsMonitor, backgroundTaskService, loggerFactory) { }
