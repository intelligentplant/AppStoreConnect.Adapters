...
namespace DataCore.Adapter.RealTimeData.Utilities {
    ...
    public class PreBoundaryInfo {
        ...
        ///   exists between <see cref="BestQualityValue"/> and the boundary timestamp.
        /// </remarks>
        /// <seealso cref="ClosestValue"/>
        public TagValueExtended? BestQualityValue { get; private set; }

        /// <summary>
        /// The value immediately before the boundary, regardless of quality.
        /// </summary>
        /// <remarks>
        ///   The <see cref="BestQualityValue"/> and <see cref="ClosestValue"/> properties will be 
        ///   different if a sample with a lower quality than <see cref="BestQualityValue"/> 
        ...
        /// <summary>
        /// Gets a collection of values that form the pre-boundary region. Up to two samples will 
        /// be emitted.
        /// </summary>
        /// <returns>
