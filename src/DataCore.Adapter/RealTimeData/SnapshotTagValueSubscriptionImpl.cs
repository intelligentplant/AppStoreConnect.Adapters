...
namespace DataCore.Adapter.RealTimeData {
    ...
    /// </summary>
    public sealed class SnapshotTagValueSubscriptionImpl : SnapshotTagValueSubscription {
        ...
        /// </exception>
        public SnapshotTagValueSubscriptionImpl(
    ...
    public class SnapshotTagValueStreamOptions {
        ...
        /// </summary>
        public Func<SnapshotTagValueSubscriptionImpl, TagIdentifier, Task> OnTagAdded { get; set; }

        /// <summary>
        /// A delegate that is invoked when a tag is removed from the subscription.
        /// </summary>
        public Func<SnapshotTagValueSubscriptionImpl, TagIdentifier, Task> OnTagRemoved { get; set; }

        /// <summary>
        /// A delegate that is invoked when the subscription is cancelled.
        /// </summary>
        public Action<SnapshotTagValueSubscriptionImpl> OnCancelled { get; set; }
