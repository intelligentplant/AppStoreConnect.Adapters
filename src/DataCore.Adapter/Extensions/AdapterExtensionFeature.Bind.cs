...
namespace DataCore.Adapter.Extensions {
    public partial class AdapterExtensionFeature {
        ...
        /// </remarks>
        protected bool BindInvoke<TFeature, T1, T2>(
            Func<T1?, CancellationToken, Task<T2?>> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
            ...
            return BindInvoke<TFeature>(async (ctx, req, ct) => {
                var input1 = this.ConvertFromVariant<T1>(req.Arguments.ElementAtOrDefault(0));
                var output = await handler.Invoke(input1, ct).ConfigureAwait(false);
        ...
        protected bool BindInvoke<TFeature, T1, T2>(
            ...
            return BindInvoke<TFeature>((ctx, req, ct) => {
                var input1 = this.ConvertFromVariant<T1>(req.Arguments.ElementAtOrDefault(0));
                var output = handler.Invoke(input1);
        ...
        /// </remarks>
        protected bool BindInvoke<TFeature, T1, T2, T3>(
            Func<T1?, T2?, CancellationToken, Task<T3?>> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
            ...
            return BindInvoke<TFeature>(async (ctx, req, ct) => {
                var input1 = this.ConvertFromVariant<T1>(req.Arguments.ElementAtOrDefault(0));
                var input2 = this.ConvertFromVariant<T2>(req.Arguments.ElementAtOrDefault(1));
                var output = await handler.Invoke(input1, input2, ct).ConfigureAwait(false);
        ...
        protected bool BindInvoke<TFeature, T1, T2, T3>(
            ...
            return BindInvoke<TFeature>((ctx, req, ct) => {
                var input1 = this.ConvertFromVariant<T1>(req.Arguments.ElementAtOrDefault(0));
                var input2 = this.ConvertFromVariant<T2>(req.Arguments.ElementAtOrDefault(1));
                var output = handler.Invoke(input1, input2);
        ...
        /// </remarks>
        protected bool BindInvoke<TFeature, T1, T2, T3, T4>(
            Func<T1?, T2?, T3?, CancellationToken, Task<T4?>> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
            ...
            return BindInvoke<TFeature>(async (ctx, req, ct) => {
                ...
                var input2 = this.ConvertFromVariant<T2>(req.Arguments.ElementAtOrDefault(1));
                var input3 = this.ConvertFromVariant<T3>(req.Arguments.ElementAtOrDefault(2));
                var output = await handler.Invoke(input1, input2, input3, ct).ConfigureAwait(false);
        ...
        protected bool BindInvoke<TFeature, T1, T2, T3, T4>(
            ...
            return BindInvoke<TFeature>((ctx, req, ct) => {
                ...
                var input2 = this.ConvertFromVariant<T2>(req.Arguments.ElementAtOrDefault(1));
                var input3 = this.ConvertFromVariant<T3>(req.Arguments.ElementAtOrDefault(2));
                var output = handler.Invoke(input1, input2, input3);
        ...
        /// </remarks>
        protected bool BindInvoke<TFeature, T1, T2, T3, T4, T5>(
            Func<T1?, T2?, T3?, T4?, CancellationToken, Task<T5?>> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
            ...
            return BindInvoke<TFeature>(async (ctx, req, ct) => {
                ...
                var input3 = this.ConvertFromVariant<T3>(req.Arguments.ElementAtOrDefault(2));
                var input4 = this.ConvertFromVariant<T4>(req.Arguments.ElementAtOrDefault(3));
                var output = await handler.Invoke(input1, input2, input3, input4, ct).ConfigureAwait(false);
        ...
        protected bool BindInvoke<TFeature, T1, T2, T3, T4, T5>(
            ...
            return BindInvoke<TFeature>((ctx, req, ct) => {
                ...
                var input3 = this.ConvertFromVariant<T3>(req.Arguments.ElementAtOrDefault(2));
                var input4 = this.ConvertFromVariant<T4>(req.Arguments.ElementAtOrDefault(3));
                var output = handler.Invoke(input1, input2, input3, input4);
        ...
        /// </remarks>
        protected bool BindInvoke<TFeature, T1, T2, T3, T4, T5, T6>(
            Func<T1?, T2?, T3?, T4?, T5?, CancellationToken, Task<T6?>> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
            ...
            return BindInvoke<TFeature>(async (ctx, req, ct) => {
                ...
                var input4 = this.ConvertFromVariant<T4>(req.Arguments.ElementAtOrDefault(3));
                var input5 = this.ConvertFromVariant<T5>(req.Arguments.ElementAtOrDefault(4));
                var output = await handler.Invoke(input1, input2, input3, input4, input5, ct).ConfigureAwait(false);
        ...
        /// </remarks>
        protected bool BindInvoke<TFeature, T1, T2, T3, T4, T5, T6>(
            Func<T1?, T2?, T3?, T4?, T5?, T6?> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
            ...
            return BindInvoke<TFeature>((ctx, req, ct) => {
                ...
                var input4 = this.ConvertFromVariant<T4>(req.Arguments.ElementAtOrDefault(3));
                var input5 = this.ConvertFromVariant<T5>(req.Arguments.ElementAtOrDefault(4));
                var output = handler.Invoke(input1, input2, input3, input4, input5);
        ...
        /// </remarks>
        protected bool BindInvoke<TFeature, T1, T2, T3, T4, T5, T6, T7>(
            Func<T1?, T2?, T3?, T4?, T5?, T6?, CancellationToken, Task<T7?>> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
            ...
            return BindInvoke<TFeature>(async (ctx, req, ct) => {
                ...
                var input5 = this.ConvertFromVariant<T5>(req.Arguments.ElementAtOrDefault(4));
                var input6 = this.ConvertFromVariant<T6>(req.Arguments.ElementAtOrDefault(5));
                var output = await handler.Invoke(input1, input2, input3, input4, input5, input6, ct).ConfigureAwait(false);
        ...
        /// </remarks>
        protected bool BindInvoke<TFeature, T1, T2, T3, T4, T5, T6, T7>(
            Func<T1?, T2?, T3?, T4?, T5?, T6?, T7?> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
            ...
            return BindInvoke<TFeature>((ctx, req, ct) => {
                ...
                var input5 = this.ConvertFromVariant<T5>(req.Arguments.ElementAtOrDefault(4));
                var input6 = this.ConvertFromVariant<T6>(req.Arguments.ElementAtOrDefault(5));
                var output = handler.Invoke(input1, input2, input3, input4, input5, input6);
        ...
        /// </remarks>
        protected bool BindInvoke<TFeature, T1, T2, T3, T4, T5, T6, T7, T8>(
            Func<T1?, T2?, T3?, T4?, T5?, T6?, T7?, CancellationToken, Task<T8?>> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
            ...
            return BindInvoke<TFeature>(async (ctx, req, ct) => {
                ...
                var input6 = this.ConvertFromVariant<T6>(req.Arguments.ElementAtOrDefault(5));
                var input7 = this.ConvertFromVariant<T7>(req.Arguments.ElementAtOrDefault(6));
                var output = await handler.Invoke(input1, input2, input3, input4, input5, input6, input7, ct).ConfigureAwait(false);
        ...
        /// </remarks>
        protected bool BindInvoke<TFeature, T1, T2, T3, T4, T5, T6, T7, T8>(
            Func<T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
            ...
            return BindInvoke<TFeature>((ctx, req, ct) => {
                ...
                var input6 = this.ConvertFromVariant<T6>(req.Arguments.ElementAtOrDefault(5));
                var input7 = this.ConvertFromVariant<T7>(req.Arguments.ElementAtOrDefault(6));
                var output = handler.Invoke(input1, input2, input3, input4, input5, input6, input7);
        ...
        /// </remarks>
        protected bool BindInvoke<TFeature, T1, T2, T3, T4, T5, T6, T7, T8, T9>(
            Func<T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, CancellationToken, Task<T9?>> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
            ...
            return BindInvoke<TFeature>(async (ctx, req, ct) => {
                ...
                var input7 = this.ConvertFromVariant<T7>(req.Arguments.ElementAtOrDefault(6));
                var input8 = this.ConvertFromVariant<T8>(req.Arguments.ElementAtOrDefault(7));
                var output = await handler.Invoke(input1, input2, input3, input4, input5, input6, input7, input8, ct).ConfigureAwait(false);
        ...
        /// </remarks>
        protected bool BindInvoke<TFeature, T1, T2, T3, T4, T5, T6, T7, T8, T9>(
            Func<T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
            ...
            return BindInvoke<TFeature>((ctx, req, ct) => {
                ...
                var input7 = this.ConvertFromVariant<T7>(req.Arguments.ElementAtOrDefault(6));
                var input8 = this.ConvertFromVariant<T8>(req.Arguments.ElementAtOrDefault(7));
                var output = handler.Invoke(input1, input2, input3, input4, input5, input6, input7, input8);
        ...
        /// </remarks>
        protected bool BindStream<TFeature, T>(
            Func<CancellationToken, IAsyncEnumerable<T?>> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
        ...
        /// </remarks>
        protected bool BindStream<TFeature, T1, T2>(
            Func<T1?, CancellationToken, IAsyncEnumerable<T2?>> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
            ...
            async IAsyncEnumerable<InvocationResponse> RunHandler(
                ...
                var input1 = this.ConvertFromVariant<T1>(req.Arguments.ElementAtOrDefault(0));
                await foreach (var item in handler.Invoke(input1, ct).ConfigureAwait(false)) {
                    if (item is InvocationResponse ir) {
                        yield return ir;
                        continue;
                    }
        ...
        /// </remarks>
        protected bool BindDuplexStream<TFeature, T1, T2>(
            Func<IAsyncEnumerable<T1?>, CancellationToken, IAsyncEnumerable<T2?>> handler,
            string? name = null,
            string? description = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? inputParameters = null,
            IEnumerable<ExtensionFeatureOperationParameterDescriptor>? outputParameters = null,
