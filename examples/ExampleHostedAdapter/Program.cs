...
// Register OpenTelemetry tracing. This can be safely removed if not required.
...
// Register OpenTelemetry metrics. This can be safely removed if not required.
builder.Services.AddOpenTelemetryMetrics(otel => otel
    ...
    .AddMeter(DataCore.Adapter.Diagnostics.Telemetry.Meter.Name)
    // Exports metrics in Prometheus format using default settings.
